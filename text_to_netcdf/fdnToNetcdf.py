...
def fdn_to_netcdf(fdnFile, disFile, locationFile, fileOutput):
	...
	# Global attributes
	ncfile.title = 'Modflow Formatted Drawdown Package'
	ncfile.bands = 1
	ncfile.bands_name = 'nsteps'
	ncfile.bands_desc = 'Variable information for ' + fdnFile
